...
class CalendarbossViewController: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    let DaysOfMonth = ["Lunes","Martes","Miercoles","Jueves","Viernes","Sábado","Domingo"]
